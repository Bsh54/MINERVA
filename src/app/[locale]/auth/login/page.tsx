    ...
    <>
      ...
      <form action={handleLogin} className="space-y-4 flex flex-col">
        ...
        <div className="flex items-center my-4">
          ...
          <span className="px-3 text-xs font-medium text-stem-400 uppercase tracking-widest">{t('orEmail')}</span>
          <div className="flex-grow border-t border-stem-100"></div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <a href="#" className="text-xs font-bold text-accent-500 hover:text-accent-600">Mot de passe oublié ?</a>
            </div>
            <input 
              type="password" 
              name="password" 
      ...
      <div className="mt-6 text-center bg-stem-50 p-3 rounded-xl border border-stem-100">
        <Link href="/auth/register" className="text-xs font-bold text-stem-600 hover:text-stem-900 transition-colors">
          {t('noAccount')}
        </Link>
      </div>
    </>
